...
export const GL_LABEL_LIGHT_TEXT_COLOR = '#fff'; // Used for the label text color on a light background color.
...
export const GL_LABEL_LIGHT_BUTTON_BACKGROUND_COLOR_HOVER = '#fff'; // Used for the label remove button background on a light background color in the hover state.
export const GL_LABEL_LIGHT_BUTTON_ICON_COLOR_DEFAULT = '#fff'; // Used for the label remove button icon on a light background color in the default state.
