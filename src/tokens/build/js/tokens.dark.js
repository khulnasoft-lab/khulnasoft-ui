...
export const GL_EDITOR_TEXT_SELECTION_BACKGROUND_COLOR = '#064787'; // Used for the background when text is selected in an editor.
export const GL_EDITOR_MEDIA_SELECTION_BACKGROUND_COLOR = '#0b5cad'; // Used for the background when a media element is selected in an editor.
