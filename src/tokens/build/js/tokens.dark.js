...
export const GL_BUTTON_CONFIRM_TERTIARY_BACKGROUND_COLOR_HOVER = 'rgba(31, 117, 203, 0.24)'; // Used for the background of a borderless, tertiary confirm (positive) button in the hover state.
export const GL_BUTTON_CONFIRM_TERTIARY_BACKGROUND_COLOR_FOCUS = 'rgba(31, 117, 203, 0.24)'; // Used for the background of a borderless, tertiary confirm (positive) button in the focus state.
export const GL_BUTTON_CONFIRM_TERTIARY_BACKGROUND_COLOR_ACTIVE = 'rgba(31, 117, 203, 0.32)'; // Used for the background of a borderless, tertiary confirm (positive) button in the active state.
...
export const GL_BUTTON_DANGER_TERTIARY_BACKGROUND_COLOR_HOVER = 'rgba(221, 43, 14, 0.24)'; // Used for the background of a borderless, tertiary danger (destructive) button in the hover state.
export const GL_BUTTON_DANGER_TERTIARY_BACKGROUND_COLOR_FOCUS = 'rgba(221, 43, 14, 0.24)'; // Used for the background of a borderless, tertiary danger (destructive) button in the focus state.
export const GL_BUTTON_DANGER_TERTIARY_BACKGROUND_COLOR_ACTIVE = 'rgba(221, 43, 14, 0.32)'; // Used for the background of a borderless, tertiary danger (destructive) button in the active state.
