...
export const GL_POPOVER_BACKGROUND_COLOR = '#4c4b51'; // Used for the background color of popover.
export const GL_POPOVER_LINK_COLOR = '#9dc7f1'; // Used for the color of a link in a popover.
...
export const GL_FEEDBACK_STRONG_BACKGROUND_COLOR = '#4c4b51'; // Used for a background associated with strong feedback like a tooltip or toast message.
...
export const GL_FEEDBACK_STRONG_LINK_COLOR = '#9dc7f1'; // Used for a link on a strong feedback background.
