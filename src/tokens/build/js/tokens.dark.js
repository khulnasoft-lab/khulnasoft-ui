...
export const GL_LABEL_SCOPED_TEXT_COLOR = '#bfbfc3'; // Used for the scoped label text color.
...
export const GL_LABEL_SCOPED_BUTTON_ICON_COLOR_DEFAULT = '#dcdcde'; // Used for the scoped label remove button icon in the default state.
