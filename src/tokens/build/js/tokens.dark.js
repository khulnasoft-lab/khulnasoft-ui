...
export const GL_ACTION_NEUTRAL_ICON_COLOR_HOVER = '#bfbfc3';
export const GL_ACTION_NEUTRAL_ICON_COLOR_FOCUS = '#bfbfc3';
export const GL_ACTION_NEUTRAL_ICON_COLOR_ACTIVE = '#ececef';
...
export const GL_CONTROL_BACKGROUND_COLOR_SELECTED = '#428fdc'; // Used for checked and indeterminate (selected) form control (checkbox, radio button) background.
...
export const GL_LABEL_LIGHT_BUTTON_ICON_COLOR_DISABLED = '#737278'; // Used for the label close button icon on a light background color in the disabled state.
...
export const GL_LABEL_DARK_BUTTON_ICON_COLOR_DISABLED = '#737278'; // Used for the label close button icon on a dark background color in the disabled state.
export const GL_LABEL_SCOPED_TEXT_COLOR = '#fff'; // Used for the label text color when scoped.
...
export const GL_LABEL_SCOPED_BUTTON_BACKGROUND_COLOR_HOVER = '#fff'; // Used for the label close button background when scoped in the hover state.
...
export const GL_LABEL_SCOPED_BUTTON_ICON_COLOR_DEFAULT = '#fff'; // Used for the label close button icon when scoped in the default state.
export const GL_LABEL_SCOPED_BUTTON_ICON_COLOR_HOVER = '#1f1e24'; // Used for the label close button icon when scoped in the hover state.
export const GL_LABEL_SCOPED_BUTTON_ICON_COLOR_DISABLED = '#737278'; // Used for the label close button icon when scoped in the disabled state.
