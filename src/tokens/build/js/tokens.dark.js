...
export const GL_BACKGROUND_COLOR_BODY = '#18171d'; // Used for the body (page) background color.
export const GL_BACKGROUND_COLOR_DEFAULT = '#3a383f'; // Used for the default background color of content or elements when the page background or contents are covered.
export const GL_BACKGROUND_COLOR_SUBTLE = '#28272d'; // Used to slightly differentiate the background from the default.
export const GL_BACKGROUND_COLOR_STRONG = '#4c4b51'; // Used to make the background easily stand out from the default.
...
export const GL_CONTAINER_HEADER_BACKGROUND_COLOR = '#3a383f'; // Used for the header background color of a basic container.
export const GL_CONTAINER_CONTENT_BACKGROUND_COLOR = '#28272d'; // Used for the content background color of a basic container.
export const GL_CONTAINER_BORDER_COLOR = '#18171d'; // Used for the border color of a basic container.
...
export const GL_FOCUS_RING_INNER_COLOR = '#3a383f'; // Used for the inner neutral portion of the focus ring.
