...
export const GL_BANNER_INTRO_BORDER_COLOR = '#0b5cad'; // Used for the border of an info banner.
export const GL_BANNER_PROMO_BACKGROUND_COLOR = '#232150'; // Used for the background of a promo banner.
export const GL_BANNER_PROMO_BORDER_COLOR = '#5943b6'; // Used for the border of a promo banner.
...
export const GL_CHART_THRESHOLD_LINE_COLOR = '#c91c00'; // Used in charts to divide a threshold area in a chart from other data.
