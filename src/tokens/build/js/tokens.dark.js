...
export const GL_CONTROL_BORDER_COLOR_SELECTED_DEFAULT = '#63a6e9'; // Used for checked and indeterminate (selected) form control (checkbox, radio button) border.
...
export const GL_CONTROL_ICON_COLOR_DEFAULT = '#18171d'; // Used for checkbox and radio button state indicators.
