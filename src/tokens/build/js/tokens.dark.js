...
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_DEFAULT = '#ececef'; // Used for the foreground of a selected action in the default state.
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_HOVER = '#ececef'; // Used for the foreground of a selected action in the hover state.
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_FOCUS = '#ececef'; // Used for the foreground of a selected action in the focus state.
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_ACTIVE = '#ececef'; // Used for the foreground of a selected action in the active state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_DEFAULT = '#033464'; // Used for the background of a selected action in the default state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_HOVER = '#064787'; // Used for the background of a selected action in the hover state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_FOCUS = '#064787'; // Used for the background of a selected action in the focus state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_ACTIVE = '#0b5cad'; // Used for the background of a selected action in the active state.
export const GL_ACTION_SELECTED_BORDER_COLOR_DEFAULT = '#428fdc'; // Used for the border of a selected action in the default state.
export const GL_ACTION_SELECTED_BORDER_COLOR_HOVER = '#63a6e9'; // Used for the border of a selected action in the hover state.
export const GL_ACTION_SELECTED_BORDER_COLOR_FOCUS = '#63a6e9'; // Used for the border of a selected action in the focus state.
export const GL_ACTION_SELECTED_BORDER_COLOR_ACTIVE = '#9dc7f1'; // Used for the border of a selected action in the active state.
