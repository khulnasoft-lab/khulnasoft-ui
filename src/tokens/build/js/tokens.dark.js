...
export const GL_SEVERITY_CRITICAL_BACKGROUND_COLOR = '#ec5941'; // Critical severity status background color.
export const GL_SEVERITY_CRITICAL_TEXT_COLOR = '#f57f6c'; // Critical severity status text color.
export const GL_SEVERITY_CRITICAL_ICON_COLOR = '#ec5941'; // Critical severity status icon color.
export const GL_SEVERITY_HIGH_BACKGROUND_COLOR = '#f57f6c'; // High severity status background color.
export const GL_SEVERITY_HIGH_TEXT_COLOR = '#fcb5aa'; // High severity status text color.
export const GL_SEVERITY_HIGH_ICON_COLOR = '#f57f6c'; // High severity status icon color.
export const GL_SEVERITY_MEDIUM_BACKGROUND_COLOR = '#d99530'; // Medium severity status background color.
export const GL_SEVERITY_MEDIUM_TEXT_COLOR = '#e9be74'; // Medium severity status text color.
export const GL_SEVERITY_MEDIUM_ICON_COLOR = '#d99530'; // Medium severity status icon color.
export const GL_SEVERITY_LOW_BACKGROUND_COLOR = '#c17d10'; // Low severity status background color.
export const GL_SEVERITY_LOW_TEXT_COLOR = '#d99530'; // Low severity status text color.
export const GL_SEVERITY_LOW_ICON_COLOR = '#c17d10'; // Low severity status icon color.
