...
export const GL_BUTTON_DEFAULT_TERTIARY_BACKGROUND_COLOR_HOVER = '#28272d'; // Used for the background of a default borderless, tertiary button in the hover state.
export const GL_BUTTON_DEFAULT_TERTIARY_BACKGROUND_COLOR_FOCUS = '#28272d'; // Used for the background of a default borderless, tertiary button in the focus state.
export const GL_BUTTON_DEFAULT_TERTIARY_BACKGROUND_COLOR_ACTIVE = '#3a383f'; // Used for the background of a default borderless, tertiary button in the active state.
...
export const GL_BUTTON_CONFIRM_TERTIARY_BACKGROUND_COLOR_HOVER = '#033464'; // Used for the background of a borderless, tertiary confirm (positive) button in the hover state.
export const GL_BUTTON_CONFIRM_TERTIARY_BACKGROUND_COLOR_FOCUS = '#033464'; // Used for the background of a borderless, tertiary confirm (positive) button in the focus state.
export const GL_BUTTON_CONFIRM_TERTIARY_BACKGROUND_COLOR_ACTIVE = '#064787'; // Used for the background of a borderless, tertiary confirm (positive) button in the active state.
...
export const GL_BUTTON_DANGER_TERTIARY_BACKGROUND_COLOR_HOVER = '#660e00'; // Used for the background of a borderless, tertiary danger (destructive) button in the hover state.
export const GL_BUTTON_DANGER_TERTIARY_BACKGROUND_COLOR_FOCUS = '#660e00'; // Used for the background of a borderless, tertiary danger (destructive) button in the focus state.
export const GL_BUTTON_DANGER_TERTIARY_BACKGROUND_COLOR_ACTIVE = '#8d1300'; // Used for the background of a borderless, tertiary danger (destructive) button in the active state.
...
export const GL_BUTTON_DISABLED_BACKGROUND_COLOR = '#28272d'; // Used for the background of a disabled button.
