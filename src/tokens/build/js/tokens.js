...
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_DEFAULT = '#28272d'; // Used for the foreground of a selected action in the default state.
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_HOVER = '#28272d'; // Used for the foreground of a selected action in the hover state.
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_FOCUS = '#28272d'; // Used for the foreground of a selected action in the focus state.
export const GL_ACTION_SELECTED_FOREGROUND_COLOR_ACTIVE = '#28272d'; // Used for the foreground of a selected action in the active state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_DEFAULT = '#e9f3fc'; // Used for the background of a selected action in the default state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_HOVER = '#cbe2f9'; // Used for the background of a selected action in the hover state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_FOCUS = '#cbe2f9'; // Used for the background of a selected action in the focus state.
export const GL_ACTION_SELECTED_BACKGROUND_COLOR_ACTIVE = '#9dc7f1'; // Used for the background of a selected action in the active state.
...
export const GL_ACTION_SELECTED_BORDER_COLOR_HOVER = '#1068bf'; // Used for the border of a selected action in the hover state.
export const GL_ACTION_SELECTED_BORDER_COLOR_FOCUS = '#1068bf'; // Used for the border of a selected action in the focus state.
export const GL_ACTION_SELECTED_BORDER_COLOR_ACTIVE = '#0b5cad'; // Used for the border of a selected action in the active state.
