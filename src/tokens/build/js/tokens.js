...
export const GL_BACKGROUND_COLOR_BODY = '#fff'; // Used for the body (page) background color.
export const GL_BACKGROUND_COLOR_DEFAULT = '#fff'; // Used for the default background color of content or elements when the page background or contents are covered.
...
export const GL_CONTAINER_HEADER_BACKGROUND_COLOR = '#fff'; // Used for the header background color of a basic container.
export const GL_CONTAINER_CONTENT_BACKGROUND_COLOR = '#fbfafd'; // Used for the content background color of a basic container.
export const GL_CONTAINER_BORDER_COLOR = '#dcdcde'; // Used for the border color of a basic container.
