...
export const GL_BUTTON_DEFAULT_TERTIARY_BACKGROUND_COLOR_HOVER = 'rgba(05, 05, 06, 0.06)'; // Used for the background of a default borderless, tertiary button in the hover state.
export const GL_BUTTON_DEFAULT_TERTIARY_BACKGROUND_COLOR_FOCUS = 'rgba(05, 05, 06, 0.06)'; // Used for the background of a default borderless, tertiary button in the focus state.
export const GL_BUTTON_DEFAULT_TERTIARY_BACKGROUND_COLOR_ACTIVE = 'rgba(05, 05, 06, 0.16)'; // Used for the background of a default borderless, tertiary button in the active state.
