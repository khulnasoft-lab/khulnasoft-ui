...
export const GL_EDITOR_TEXT_SELECTION_BACKGROUND_COLOR = '#cbe2f9'; // Used for the background when text is selected in an editor.
export const GL_EDITOR_MEDIA_SELECTION_BACKGROUND_COLOR = '#9dc7f1'; // Used for the background when a media element is selected in an editor.
