...
export const GL_POPOVER_LINK_COLOR = '#0b5cad'; // Used for the color of a link in a popover.
...
export const GL_FEEDBACK_STRONG_BACKGROUND_COLOR = '#28272d'; // Used for a background associated with strong feedback like a tooltip or toast message.
