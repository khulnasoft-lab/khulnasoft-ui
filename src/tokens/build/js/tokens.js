...
export const GL_SEVERITY_CRITICAL_BACKGROUND_COLOR = '#8d1300'; // Critical severity status background color.
export const GL_SEVERITY_CRITICAL_TEXT_COLOR = '#8d1300'; // Critical severity status text color.
export const GL_SEVERITY_CRITICAL_ICON_COLOR = '#8d1300'; // Critical severity status icon color.
export const GL_SEVERITY_HIGH_BACKGROUND_COLOR = '#c91c00'; // High severity status background color.
export const GL_SEVERITY_HIGH_TEXT_COLOR = '#c91c00'; // High severity status text color.
export const GL_SEVERITY_HIGH_ICON_COLOR = '#c91c00'; // High severity status icon color.
export const GL_SEVERITY_MEDIUM_BACKGROUND_COLOR = '#c17d10'; // Medium severity status background color.
export const GL_SEVERITY_MEDIUM_TEXT_COLOR = '#9e5400'; // Medium severity status text color.
export const GL_SEVERITY_MEDIUM_ICON_COLOR = '#c17d10'; // Medium severity status icon color.
export const GL_SEVERITY_LOW_BACKGROUND_COLOR = '#9e5400'; // Low severity status background color.
export const GL_SEVERITY_LOW_TEXT_COLOR = '#8f4700'; // Low severity status text color.
export const GL_SEVERITY_LOW_ICON_COLOR = '#9e5400'; // Low severity status icon color.
