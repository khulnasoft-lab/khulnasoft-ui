...
export const GL_CLOSE_BUTTON_FOREGROUND_COLOR_DEFAULT = '#28272d'; // Used for the foreground of a close button in the default state.
export const GL_CLOSE_BUTTON_FOREGROUND_COLOR_HOVER = '#28272d'; // Used for the foreground of a close button in the hover state.
export const GL_CLOSE_BUTTON_FOREGROUND_COLOR_FOCUS = '#28272d'; // Used for the foreground of a close button in the focus state.
export const GL_CLOSE_BUTTON_FOREGROUND_COLOR_ACTIVE = '#28272d'; // Used for the foreground of a close button in the active state.
export const GL_CLOSE_BUTTON_BACKGROUND_COLOR_DEFAULT = 'rgba(164, 163, 168, 0.0)'; // Used for the background of a close button in the default state.
export const GL_CLOSE_BUTTON_BACKGROUND_COLOR_HOVER = 'rgba(164, 163, 168, 0.16)'; // Used for the background of a close button in the hover state.
export const GL_CLOSE_BUTTON_BACKGROUND_COLOR_FOCUS = 'rgba(164, 163, 168, 0.16)'; // Used for the background of a close button in the focus state.
export const GL_CLOSE_BUTTON_BACKGROUND_COLOR_ACTIVE = 'rgba(83, 81, 88, 0.24)'; // Used for the background of a close button in the active state.
