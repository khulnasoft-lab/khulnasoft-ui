...
export const MOCK_CONTEXT_ITEM_FILE = {
  ...
  metadata: {
    enabled: true,
    title: 'strawberry.ts',
    secondaryText: 'example/garden - src/plants/strawberry.ts',
...
export const MOCK_CONTEXT_ITEM_FILE_DISABLED = {
  ...
  metadata: {
    enabled: false,
    title: 'motorbike.cs',
    secondaryText: 'example/vehicles - /src/VehicleFoo/motorbike.cs',
    subTypeLabel: 'Project file',
    icon: 'document',
...
const mockFiles = [
  MOCK_CONTEXT_ITEM_FILE,
  {
    ...
    metadata: {
      enabled: true,
      title: 'potato.ts',
      secondaryText: 'example/garden - /src/plants/potato.ts',
      subTypeLabel: 'Project file',
      icon: 'document',
...
export const MOCK_CONTEXT_ITEM_GIT_DIFF = {
  ...
  metadata: {
    ...
    secondaryText: 'example/garden - main',
...
export const MOCK_CONTEXT_ITEM_GIT_COMMIT = {
  ...
  metadata: {
    ...
    secondaryText: 'example/garden - 20f8caf94cb8f5e5f9dbd1a9ac32702321de201b',
...
const mockGitItems = [
  ...
  MOCK_CONTEXT_ITEM_GIT_COMMIT,
  {
    ...
    metadata: {
      ...
      secondaryText: 'example/garden - 32b9b56b6de75b32909986755fbc470f20fb6fc0',
      subTypeLabel: 'Local Git repository commit',
      icon: 'commit',
  ...
  },
  {
    ...
    metadata: {
      ...
      secondaryText: 'example/garden - 775d7efdce25c1af48c55abcadbefd1f181b92ce',
      subTypeLabel: 'Local Git repository commit',
      icon: 'commit',
