...
const Template = (args, { argTypes }) => ({
  ...
  template: `
    <gl-duo-chat-conversation :canceledRequestIds=[] :messages="messages" :show-delimiter="showDelimiter" />
  `,
});
...
export const MultipleConversations = (args, { argTypes }) => ({
  ...
  template: `
    <div>
      <gl-duo-chat-conversation :canceledRequestIds=[] :messages="messages" :show-delimiter="false" />
      <gl-duo-chat-conversation :canceledRequestIds=[] :messages="messages" :show-delimiter="true" />
    </div>
  `,
});
