...
To update the `@khulnasoft/ui` dependency of GitLab locally for development, see [KhulnaSoft integration](contributing/khulnasoft_integration_test.md).
